...
class easy_ipa (
  ...
  String        $ad_netbios_name                    = undef,
  String        $ad_domain_name                     = undef,
  String        $ad_admin_name                      = undef,
  String        $ad_admin_password                  = undef,
  String        $package_trust_ad_role              =$::osfamily ? {
    'Debian' => 'freeipa-server-trust-ad',
    default  => 'ipa-server-trust-ad',
  },
  Array[String] $package_trust_ad_agent_role        =$::osfamily ? {
